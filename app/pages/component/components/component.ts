...
import {BUTTON_DIRECTIVES, TAB_DIRECTIVES, DROPDOWN_DIRECTIVES, TYPEAHEAD_DIRECTIVES,
 Collapse, PAGINATION_DIRECTIVES, Rating} from 'ng2-bootstrap/ng2-bootstrap';
...
@Component({
  ...
  directives: [BUTTON_DIRECTIVES, CORE_DIRECTIVES, TAB_DIRECTIVES, TYPEAHEAD_DIRECTIVES,
   FORM_DIRECTIVES, DROPDOWN_DIRECTIVES, Rating, Collapse, PAGINATION_DIRECTIVES]
})
